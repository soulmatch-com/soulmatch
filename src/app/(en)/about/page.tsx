...
export default async function AboutPage() {
  ...
  return <><JsonLd data={{ '@context': 'https://schema.org', '@type': 'AboutPage', name: 'About MyThirumanam', url, description }} /><main className="min-h-screen bg-[#fffaf3] text-stone-900">
    ...
    <section className="mx-auto max-w-6xl px-4 pb-4 sm:px-6"><div className="max-w-4xl"><h2 className="sr-only">Independent service disclaimer</h2><div className="space-y-3"><IndependentServiceNotice variant="full" /><IndependentServiceNotice locale="ta" variant="full" /></div></div></section>
